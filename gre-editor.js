        ...
        return this.filter('textarea').each(() => {
            ...
            if (status) {
                ...
                if (settings.lang == 'ar' || settings.lang == 'fa'){
                    ...
                    $('#main-gre-editor').find('#edit-link').css('right','0');
                }else{
                    $('#main-gre-editor').find('#edit-link').css('top','0');
                ...
                $('#main-gre-editor').find('#edit-link').append('<input type="text" id="edit-link-url" dir="ltr" style="font-family:sans-serif;color:#333;font-size:16px;font-family:sans-serif;padding:4px;border-radius:3px;-webkit-border-radius:3px;border:1px solid #aaa;margin-top:6px;width:100%;outline:none;-webkit-outline:none;appearance:none;-webkit-appearance:none;box-sizing:border-box;-webkit-box-sizing:border-box;" placeholder="' + langCore.url + '">');
                $('#main-gre-editor').find('#edit-link').append('<input type="text" id="edit-link-title" dir="ltr" style="font-family:sans-serif;color:#333;font-size:16px;font-family:sans-serif;padding:4px;border-radius:3px;-webkit-border-radius:3px;border:1px solid #aaa;margin-top:6px;width:100%;outline:none;-webkit-outline:none;appearance:none;-webkit-appearance:none;box-sizing:border-box;-webkit-box-sizing:border-box;" placeholder="' + langCore.title + '">');
